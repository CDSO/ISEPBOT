...
CmdletsToExport = 'Get-GcLogEntry', 'New-GcLogEntry', 'New-GcLogMonitoredResource', 
               ...
               'Get-GcIamPolicyBinding', 'Add-GcIamPolicyBinding', 'Get-BqDataset', 
               'Set-BqDataset', 'New-BqDataset', 'Remove-BqDataset', 'Get-BqTable', 
               'Set-BqTable', 'New-BqTable', 'Remove-BqTable', 'New-BqSchema', 
               'Set-BqSchema', 'Add-BqTableRows', 'Get-BqTableRows', 'Get-BqJob', 
               'Start-BqJob', 'Receive-BqJob', 'Stop-BqJob', 'Get-GkeCluster', 
               'New-GkeNodeConfig', 'Add-GkeCluster', 'Remove-GkeCluster', 
               'Add-GkeNodePool', 'Get-GkeNodePool', 'New-GkeNodePool'
