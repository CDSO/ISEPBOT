...
RootModule = '..\PowerShell\GoogleCloud\1.0.0.6\GoogleCloud.psm1'
...
FormatsToProcess = 
               '..\PowerShell\GoogleCloud\1.0.0.6\GoogleCloudPlatform.Format.ps1xml'
...
CmdletsToExport = 'Add-BqTableRow', 'Add-GcdChange', 'Add-GcdManagedZone', 
               'Add-GceAddress', 'Add-GceFirewall', 'Add-GceHealthCheck', 
               'Add-GceImage', 'Add-GceInstance', 'Add-GceInstanceTemplate', 
               'Add-GceManagedInstanceGroup', 'Add-GceRoute', 'Add-GceSnapshot', 
               'Add-GcsBucketAcl', 'Add-GcsDefaultObjectAcl', 'Add-GcsObjectAcl', 
               'Add-GcSqlInstance', 'Add-GcSqlSslCert', 'Add-GcSqlSslEphemeral', 
               'ConvertTo-GcSqlInstance', 'Copy-GcsObject', 'Disable-GceImage', 
               'Export-GcSqlInstance', 'Get-BqTableRow', 'Get-GcdChange', 
               ...
               'Get-GcLogMetric', 'Get-GcpProject', 'Get-GcsBucket', 
               'Get-GcsBucketAcl', 'Get-GcsDefaultObjectAcl', 'Get-GcsObject', 
               'Get-GcsObjectAcl', 'Get-GcSqlBackupRun', 'Get-GcSqlFlags', 
               'Get-GcSqlInstance', 'Get-GcSqlOperation', 'Get-GcSqlSslCert', 
               'Get-GcSqlTiers', 'Import-GcSqlInstance', 
               ...
               'New-GcLogMetric', 'New-GcsBucket', 'New-GcsObject', 
               'New-GcSqlInstanceConfig', 'New-GcSqlInstanceReplicaConfig', 
               'New-GcSqlSettingConfig', 'Read-GcsObject', 'Remove-GcdManagedZone', 
               'Remove-GceAddress', 'Remove-GceDisk', 'Remove-GceFirewall', 
               'Remove-GceHealthCheck', 'Remove-GceImage', 'Remove-GceInstance', 
               'Remove-GceInstanceTemplate', 'Remove-GceManagedInstanceGroup', 
               'Remove-GceRoute', 'Remove-GceSnapshot', 'Remove-GcIamPolicyBinding', 
               'Remove-GcLogMetric', 'Remove-GcsBucket', 'Remove-GcsBucketAcl', 
               'Remove-GcsBucketLogging', 'Remove-GcsBucketWebsite', 
               'Remove-GcsDefaultObjectAcl', 'Remove-GcsObject', 
               'Remove-GcsObjectAcl', 'Remove-GcSqlBackupRun', 
               'Remove-GcSqlInstance', 'Remove-GcSqlSslCert', 'Reset-GcSqlSslConfig', 
               'Resize-GceDisk', 'Restart-GceInstance', 'Restart-GcSqlInstance', 
               'Restore-GcSqlInstanceBackup', 'Set-GceFirewall', 
               'Set-GceHealthCheck', 'Set-GceInstance', 
               'Set-GceManagedInstanceGroup', 'Set-GceTargetPool', 'Set-GcLogMetric', 
               'Set-GcLogSink', 'Set-GcsObject', 'Start-GceInstance', 
               'Start-GcSqlReplica', 'Stop-GceInstance', 'Stop-GcSqlReplica', 
               'Test-GcsBucket', 'Test-GcsObject', 'Update-GcSqlInstance', 
               'Wait-GceManagedInstanceGroup', 'Write-GcsBucketLogging', 
               'Write-GcsBucketWebsite', 'Write-GcsObject'
